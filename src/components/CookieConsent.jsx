    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 px-4 py-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl max-h-[85vh] flex flex-col">
        ...
        <div className="overflow-y-auto px-5 py-4 space-y-4 text-gray-700 text-sm leading-6 flex-1">
          ...
          <section>
            <h2 className="text-base font-bold text-orange-900 mb-1">How Do Third Parties Use Cookies on This Website?</h2>
            <p>Third-party companies, such as analytics providers and ad networks, may use cookies to collect information about users on an anonymous basis. This data may be used to build profiles of your activities on this Website and on other websites you visit.</p>
          </section>

          <section>
            <h2 className="text-base font-bold text-orange-900 mb-1">Your Cookie Options</h2>
            <p className="mb-2">{`You can manage your cookie preferences by adjusting your browser settings. You may delete existing cookies or configure your browser to block new cookies. For further instructions, consult your browser's help section.`}</p>
            <p>Please note that if you delete or block cookies, certain features of the Website may not function properly, some content may not display correctly, and your preferences may not be saved.</p>
          </section>
