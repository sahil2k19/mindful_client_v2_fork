...
const Thankyoupage2 = ({ whatsapp = '9606030958' }) => {
    ...
    const practoUrl = searchParams.get('practourl') || '';
        ...
        <Container maxWidth="lg bg-primary-div h-screen " >
            <div className=" flex flex-col items-center  justify-center h-full ">
                <div className="rounded-lg pb-[50px]  p-2 w-full text-center">
                    ...
                    {practoUrl ? (
                        <div className="mt-6">
                            <p className="  text-red-700 text-xl md:text-2xl mb-4">
                                Redirecting you to Practo in <span className="font-bold text-2xl block">{countdown} Second{countdown !== 1 ? 's' : ''}…</span> 
                            </p>
