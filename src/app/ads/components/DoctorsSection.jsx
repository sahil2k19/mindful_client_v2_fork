            ...
            <div className="flex flex-wrap gap-6 justify-center">
              {doctors.map((doctor) => (
                ...
                >
                  ...
                  <div className="mb-1 text-center">
                    <p className="font-semibold text-sm md:text-lg text-center text-gray-800 max-w-[150px]">
                      {doctor.name}
                    </p>
                    <label className="text-[13px] lg:text-[15px] text-gray-700 max-w-[200px]">
                      {`${doctor.designation}`}
                    ...
                    {doctorFees[doctor.name] && (
                      <p className="text-[14px] lg:text-[17px] text-orange-500 font-bold mt-1">
                        {doctorFees[doctor.name]}
                      </p>
                    )}
                  </div>
          ...
          <div className="hidden md:flex flex-wrap justify-center gap-[90px] ">
            {doctors.map((doctor) => (
              ...
              >
                ...
                <div className="mb-1 text-center">
                  <p className="font-semibold text-lg text-center lg:text-[18px] text-gray-800 max-w-[200px]">
                    {doctor.name}
                  </p>
                  ...
                  {doctorFees[doctor.name] && (
                    <p className="text-[15px] lg:text-[17px] text-orange-500 font-bold  mt-1">
                      {doctorFees[doctor.name]}
                    </p>
                  )}
                </div>
