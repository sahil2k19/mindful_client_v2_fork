...
export default function TestimonialComponentV2({
    location,
    condition,
    disableSlide,
    setDisableSlide,
    ...
    const QuoteComponent = ({ testimonial, modalOpen, index }) => {
        ...
        return (
            <>
                {/* Testimonial Card */}
                <div className="bg-white shadow-md rounded-lg p-6 h-[321px] ">
    ...
    const SkeletonCard = () => (
        <div className="bg-white shadow-md rounded-lg p-6 h-[321px] mx-5 animate-pulse">
          <div className="flex flex-col justify-between h-full">
            {/* Header */}
            <div>
              <div className="flex items-center mb-8">
