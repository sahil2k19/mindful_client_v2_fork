...
export async function generateMetadata() {
  return {
    title: `rTMS for Parkinson's | MindfulTMS Neurocare`,
    description: `rTMS for Parkinson's: safe, painless brain stimulation. MindfulTMS Neurocare — Delhi & Bengaluru. Request a free call.`,
...
const page = () => {
  ...
  return (
    <>
      <Script id="zfadvlead-parkinsons-index" strategy="afterInteractive">
        {`(function(){
  function ZFAdvLead(){}
