...
export async function generateMetadata() {
  return {
    title: `rTMS for Parkinson's | MindfulTMS Neurocare — Bengaluru`,
    description: `rTMS for Parkinson's: safe, painless brain stimulation. MindfulTMS Neurocare, Whitefield, Bengaluru. Request a free call.`,
...
const page = () => {
  ...
  return (
    <>
      <Script id="zfadvlead-parkinsons-wf" strategy="afterInteractive">
        {`(function(){
  function ZFAdvLead(){}
