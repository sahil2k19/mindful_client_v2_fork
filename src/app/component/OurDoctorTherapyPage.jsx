      ...
      <section className="pt-8 pb-4 px-1">
        ...
        {Object.entries(filteredExperts).map(([location, experts], index) => (
          <div key={index} className="mb-5 md:mb-8 md:mx-[80px] lg:mx-[120px]">
            ...
            <div className="flex flex-wrap gap-4 md:gap-[90px] text-center justify-center">
              {experts.map((expert, idx) => (
                <div
                  key={idx}
                  onClick={() => handleExpertClick(expert)}
                  className="flex flex-col items-center mb-2 cursor-pointer hover:opacity-80 transition-opacity duration-200 group"
                >
                  ...
                  <div className="mb-1 text-center">
                    <p className="font-semibold text-[14px] md:text-[16px] lg:text-[18px] text-gray-800 max-w-[150px] md:max-w-[180px] lg:max-w-[200px] group-hover:text-orange-600 transition-colors duration-200">
                      {expert?.name}
                    </p>
