...
const TmsMainPage = () => {
    ...
    const getOurExperts = async () => {
        try {
            ...
            const res = await axios.get(
                `${process.env.NEXT_PUBLIC_API_URL}doctors/search/doctors?specialization=rtms`,
                {
                    headers: {
    ...
    const fourConditions = [
        { _id: 2, name: "Depression" },
        { _id: 3, name: "OCD" },
        { _id: 4, name: "Migraines" },
        { _id: 5, name: "Chronic pain" },
        { _id: 1, name: "Smoking Addiction" },
    ];

    const allConditions = [
        { _id: 6, name: "Addictions" },
        { _id: 7, name: "Anxiety" },
        { _id: 8, name: "Alzheimer's disease" },
        { _id: 9, name: "Bipolar disorder" },
        { _id: 11, name: "Eating disorders" },
        { _id: 12, name: "Essential tremor" },
        { _id: 13, name: "Fibromyalgia" },
        { _id: 14, name: "Parkinson's disease" },
        { _id: 16, name: "Schizophrenia" },
        { _id: 17, name: "Stroke complications" },
        { _id: 18, name: "Tinnitus and auditory hallucinations" },
        { _id: 19, name: "Traumatic brain injury" },
        { _id: 10, name: "Borderline personality disorder (BPD)" },
        { _id: 15, name: "Post-traumatic stress disorder (PTSD)" },
    ];
                ...
                <div className="min-h-screen">
                    <div className="">
                            ...
                            <div className='mb-10'>
                                ...
                                <div className="flex flex-wrap justify-center gap-2 ">
                                    {fourConditions.map((condition) => (
                                        <div key={condition.name} className="flex items-center bg-green-100 text-green-700 px-3 py-1.5 rounded-full">
                            ...
                            <div>
                                <div className="flex flex-wrap justify-center gap-2 ">
                                    {allConditions.map((condition) => (
                                        <div key={condition.name} className="flex items-center bg-green-100 text-sm text-green-700 px-3 py-1.5 rounded-full">
                                            <span className='font-semibold'>{condition.name}</span>
                                        </div>
                                    ))}
                                </div>
                        ...
                        <div className="bg-white px-4 py-8 lg:p-10 ">
                            ...
                            <p className="text-start text-gray-700 mb-5">Consider rTMS if you</p>
                            <ul className="list-disc text-gray-700 text-md px-5">
                                <li className='mb-5'><strong>{`Have a Diagnosis:`}</strong> {`You have a diagnosis of major depressive disorder, anxiety disorders, OCD, or PTSD.`}</li>
                                <li className='mb-5'><strong>{`Are concerned about side effects of taking medication:`}</strong>{` You don't want to take medication.`}</li>
                                <li className='mb-5'><strong>{`Tried Medications:`}</strong> {` You have tried multiple medications without satisfactory results. `}</li>
                                <li className='mb-5'><strong>{`Prefer Non-Invasive Options:`}</strong> {`You prefer a non-invasive treatment option with potentially fewer side effects. `}</li>
                                <li className='mb-5'><strong>{`Open to Innovative Methods:`}</strong> {` You are open to innovative treatment methods. `}</li>
                        ...
                        <div className=" p-6 lg:p-10 bg-primary-div">
                            <h3 className="text-2xl font-semibold text-gray-800 mb-3 text-center">{`How does rTMS work?`}</h3>
                            ...
                            <div className="space-y-4 mb-6">
                                <ul className="list-decimal list-inside text-gray-700 text-md">
                                    <li className=''>
                                        ...
                                        <div className='py-5'><Image alt="img" width={500} height={500} className='w-full' src='/tmsPage/mindful_Coil Placement.webp' /></div>
                                    </li>
                                    <li className=''>
                                        ...
                                        <div className='py-5'><Image alt="img" width={500} height={500} src='/tmsPage/mindful_Stimulate Brain Cells.webp' /></div>
                                    </li>
                                    <li className=''>
                                        ...
                                        <div className='py-5'><Image alt="img" width={500} height={500} src='/tmsPage/mindful_Boost Brain Activity.webp' /></div>
                                    </li>
                                    <li className='mb-5'>
                ...
                <div className="min-h-screen">
                    <div className="">
                        <div className='h-[78vh] w-full'>
                            <Image alt="img" width={900} height={900} className='w-full h-full object-cover' src='/tmsPage/banner.webp' />
                        </div>
                        ...
                        <div className=" p-6 lg:p-10 ">
                            ...
                            <Container maxWidth="lg">
                                ...
                                <div className='flex flex-row justify-between items-center gap-4'>
                                    ...
                                    <div className='w-2/3'>
                                        <p className="text-gray-700 text-xl text-start mb-2">{`rTMS uses magnetic pulses to increase or inhibit activity of specific areas of the brain that are not functioning normally.  `}</p>
                                        <p className="text-gray-700 text-xl text-start mb-4">{`For example, in the case of depression, the brain activity is decreased. With targeted rTMS, the activity in these areas increases.  `}</p>
                                    </div>
                                </div>
                            </Container>
                        </div>
                        ...
                        <div className="bg-primary-div pt-10 pb-10 px-4 ">
                            <Container maxWidth="lg">
                                <div className='mb-10'>
                                    <h3 className="text-4xl font-bold text-center text-gray-800 mb-6 leading-tight">{`rTMS has been effective in treating`}</h3>
                                    <div className="flex flex-wrap justify-center gap-2 ">
                                        {fourConditions.map((condition) => (
                                            <div key={condition.name} className="flex items-center bg-green-100 text-base text-green-700 px-4 py-2 rounded-full">
                                ...
                                <div>
                                    <div className="flex flex-wrap justify-center gap-2 ">
                                        {allConditions.map((condition) => (
                                            <div key={condition.name} className="flex items-center bg-green-100 text-base text-green-700 px-3 py-1.5 rounded-full">
                                                <span className='font-semibold'>{condition.name}</span>
                                            </div>
                                        ))}
                                    </div>
                        ...
                        <div className="bg-white px-4 py-8 lg:p-10 ">
                            <Container maxWidth="lg">
                                <h3 className="text-4xl text-center mb-6 font-bold text-[#f6881f] ">{`Is rTMS for me?`}</h3>
                                <p className="text-start text-gray-700 mb-5">Consider rTMS if you</p>
                                <ul className="list-disc text-gray-700 text-md px-5">
                                    <li className='mb-5'><strong>{`Have a Diagnosis:`}</strong> {`You have a diagnosis of major depressive disorder, anxiety disorders, OCD, or PTSD.`}</li>
                                    <li className='mb-5'><strong>{`Are concerned about side effects of taking medication:`}</strong>{` You don't want to take medication.`}</li>
                        ...
                        <div className=" p-6 lg:p-10 bg-primary-div">
                            <Container maxWidth="lg">
                                <h3 className="text-4xl font-bold text-gray-800 mb-6 text-center">{`How does rTMS work?`}</h3>
                                <div className="mb-6 flex justify-center ">
                                    <img alt="img" src="/tmsPage/tms3.png" className="object-cover w-[650px] h-full" />
                                </div>
                                <div className="space-y-4 mb-6">
                                    <ul className="list-decimal list-inside text-gray-700 text-md">
                                        <li className='text-2xl'>
                                            <strong>{`Coil Placement:`}</strong> {` A healthcare professional places the rTMS coil on your head, targeting the specific brain area based on your condition. `}
                                            <div className='py-5 h-[400px] flex justify-center'><img alt="img" className='h-full' src='/tmsPage/mindful_Coil Placement.webp' /></div>
                                        </li>
                                        <li className='text-2xl'>
                                            <strong>{`Stimulate Brain Cells:`}</strong>{` The magnetic pulses help activate or regulate the brain cells (neurons) in those regions where the coil is targeted `}
                                            <div className='py-5 h-[400px] flex justify-center'><img alt="img" className='h-full' src='/tmsPage/mindful_Stimulate Brain Cells.webp' /></div>
                                        </li>
                                        <li className='text-2xl'>
                                            <strong>{`Boost Brain Activity:`}</strong> {` For conditions like Major Depressive Disorder (MDD), some brain areas may be less active. The pulses help increase activity in these areas, improving your mood. `}
                                            <div className='py-5 h-[400px] flex justify-center'><img alt="img" className='h-full object-cover' src='/tmsPage/mindful_Boost Brain Activity.webp' /></div>
                                        </li>
                        ...
                        {/* ✅ Testimonials Section - Desktop (just before FAQ) */}
